<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="${comment}" prop="note">
        <el-input
      ...
      <el-form-item label="${comment}" prop="other">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['sjwflowsys:dict:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['sjwflowsys:dict:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['sjwflowsys:dict:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['sjwflowsys:dict:export']"
        >导出</el-button>
      </el-col>
    </el-row>
    ...
    <el-table v-loading="loading" :data="dictList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="note" />
      <el-table-column label="${comment}" align="center" prop="other" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="${comment}" prop="other">
          <el-input v-model="form.other" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="sort">
...
<script>
import { listDict, getDict, delDict, addDict, updateDict, exportDict } from "@/api/sjwflowsys/dict";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除业务字典编号为"' + ids + '"的数据项?', "警告", {
