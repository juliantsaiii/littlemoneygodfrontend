...
export default {
  ...
  data() {
    return {
      ...
      classidx64: "A64E3073-2016-4baf-A89D-FFE1FAA10EE0",
      ...
      ProductCaption: "江苏省纪委监察委",

      //密钥

      ProductKey: "61A36E44DDBFEBA99F5EAAEDDE49A310DB0253EE",
  ...
  computed: {
    title() {
      return (
        "vue集成ntko示例" + "浏览器参数：" + this.platform + "-" + this.browser
      );
    },
    ...
    this.$nextTick(() => {
      if (this.browser == "IE") {
        if (window.navigator.platform == "Win32") {
          ...
          domStr +=
            '<object id="TANGER_OCX" classid="clsid:' +
            this.classid +
            '" codebase="' +
            this.codebase +
            '" width="' +
          ...
          domStr +=
            '<param name="MakerCaption" value="' + this.MakerCaption + '"> ';
          ...
          domStr +=
            '<param name="NoExpireKey" value="' + this.NoExpireKey + '"> ';
        ...
        if (window.navigator.platform == "Win64") {
          ...
          domStr +=
            '<object id="TANGER_OCX" classid="clsid:\'+this.classidx64+\'" codebase="' +
            this.codebase64 +
            '" width="' +
            this.width +
            '" height="' +
        ...
        domStr +=
          ...
          '" height="' +
          this.height +
          '" ForOnSaveToURL="ntkosavetourl" ForOndocumentopened="ntkoondocumentopened"';
        ...
        domStr +=
          '<SPAN STYLE="color:red">尚未安装NTKO Web FireFox跨浏览器插件</SPAN> ';
        ...
        domStr +=
          '<SPAN STYLE="color:red">尚未安装NTKO Web Chrome跨浏览器插件</SPAN> ';
