...
export function openNtkoWindow(url, isReadonly) {
    ...
    if (ntkoed) {
        console.log(url)
        ntkoBrowser.openWindow("/ntko/editindex.html?ntkourl=" + encodeURI(url) + "&isReadonly=" + isReadonly + "&urlPre=" + process.env.VUE_APP_BASE_API, false, "南京安夏电子科技有限公司某某测试用户", "EA2DD26261BAE1662BB827FB200CC90BE0C67745");
    }
}
